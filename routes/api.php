...
Route::post('update-workload-accession-no/{accession_no}/{mrn}', [OrderController::class, 'updateSimrs']);
Route::post('orders/one-day', [OrderController::class, 'showByExamedAt']);
