...
<body>
    <iframe src="http://<?= $_SERVER['SERVER_NAME']; ?>:8000/dokter-radiology/{{ $dokterRadiology->pk }}" frameborder="0" marginheight="0" marginwidth="0" width="100%" height="100%" scrolling="auto"></iframe>
